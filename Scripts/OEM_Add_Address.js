...
const input1 = prompt("Please enter the ID of the OEM: ");

const input2 = prompt("Please enter the address of the OEM node you want to add: ");

console.time('Execution time');
mycontract.methods.OEMNUpdate(input1,input2).send(parameter)
